...
import { TestPreferences } from "@/components/settings/test-preferences";
      ...
      <Tabs defaultValue="general">
        <TabsList>
          ...
          <TabsTrigger value="tests">
            <Timer className="size-4" /> Tests &amp; timing
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="general" className="space-y-6 pt-4">
          ...
          <Card>
            ...
            <CardContent className="flex items-center justify-between">
              <span className="text-sm text-muted-foreground">Groq API key</span>
              {aiOn ? (
        ...
        <TabsContent value="tests" className="pt-4">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Timer className="size-4.5 text-primary" /> Tests &amp; timing
              </CardTitle>
              <CardDescription>
                How long a mock or quiz runs, what the clock does when it reaches
                zero, and which exam conditions are enforced.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TestPreferences />
